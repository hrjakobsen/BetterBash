...
import com.d401f17.AST.Nodes.AndNode;
...
public class AndNodeTest {
    ...
    public static Collection<Object[]> data(){
        return Arrays.asList(new Object[][]{
                {Types.INT, Types.INT, Types.ERROR},
    ...
    public void AndNode_typeCheckWithParameters_expected() {
        TypeCheckVisitor typeCheckVisitor = new TypeCheckVisitor();
        AndNode node = new AndNode(new ConstantNode(1, leftType), new ConstantNode(1, rightType),0);
        node.accept(typeCheckVisitor);
        Assert.assertEquals(node.getType().getPrimitiveType(), expectedType);
    }
}